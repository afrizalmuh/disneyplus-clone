// const imgPath = `${import.meta.env.VITE_PUBLIC_URL}images`
// const imgPath = process.env.PUBLIC_URL

// export const NAV_MENU = [
//   { name: 'HOME', path: imgPath + '/home-icon.svg' },
//   { name: 'WATCHLIST', path: imgPath + '/watchlist-icon.svg' },
//   { name: 'ORIGINALS', path: imgPath + '/original.svg' },
//   { name: 'MOVIES', path: imgPath + '/movie-icon.svg' },
//   { name: 'SERIES', path: imgPath + '/series-icon.svg' },
// ]
export const NAV_MENU = [
